...
public class PerftTesting {
    ...
    public static void perft(long WP,long WB,long WN,long WR,long WQ,long WK,long BP,long BB,long BN,long BR,long BQ,
                             long BK, int depth, boolean wkcastle, boolean wqcastle, boolean bkcastle, boolean bqcastle, boolean whiteToMove, String history){
        ...
        if (depth < MAX_DEPTH){
            ...
            if (whiteToMove){
                moves = Moves.possibleWhiteMoves(allBitBoards, history);
            }else{
                moves = Moves.possibleBlackMoves(allBitBoards, history);
            }
                ...
                if (Character.isDigit(moves.charAt(i + 3))) {
                    ...
                    if (((tempWK&Moves.coveredByBlack(newBitBoards))==0&&whiteToMove) ||
                            ...
                            perft(tempWP,tempWB,tempWN,tempWR,tempWQ,tempWK,tempBP,tempBB,tempBN,tempBR,tempBQ,tempBK,
                                    depth + 1,tempWKC,tempWQC,tempBKC,tempBQC, !whiteToMove,moves.substring(i, i + 4));
                        }
                }
            }
        }
